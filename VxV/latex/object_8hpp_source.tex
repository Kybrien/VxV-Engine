...
\DoxyCodeLine{00085\ \};}
\DoxyCodeLine{00094\ \mbox{\hyperlink{class_vertex}{Vertex}}\ \mbox{\hyperlink{object_8hpp_a9f9b1e415eb80126ec987fcf9006d7f7}{createVertexFromIndex}}(\textcolor{keyword}{const}\ tinyobj::attrib\_t\&\ attrib,\ \textcolor{keyword}{const}\ tinyobj::index\_t\&\ index);}
\DoxyCodeLine{00102\ GLuint\ \mbox{\hyperlink{object_8hpp_ada2dfa2a2473899e0ec39b3ee9695cf1}{loadTexture}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ filename);}
\DoxyCodeLine{00110\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a8f490ee67f22023cf637d93730514863}{init}}(GLFWwindow*\&\ window);}
\DoxyCodeLine{00118\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a0d19ebac03a8c658fecf491ec7d7fefb}{setupInput}}(GLFWwindow*\ window);}
\DoxyCodeLine{00125\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a6e31672d5229034125de7c14588fd963}{initOpenGLSettings}}();}
\DoxyCodeLine{00133\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a6271f9c23852dede80128644794fbc4c}{initializeVertexArrayObject}}(GLuint\&\ VertexArrayID);}
\DoxyCodeLine{00140\ glm::mat4\ \mbox{\hyperlink{object_8hpp_a27bf9558ecaf7d4f22d1d02a77462ead}{initializeProjectionMatrix}}();}
\DoxyCodeLine{00147\ glm::mat4\ \mbox{\hyperlink{object_8hpp_a818cec7d86c467bdd2bbcb06a5abc722}{initializeViewMatrix}}();}
\DoxyCodeLine{00154\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_ac3e4d4cfe635daf76270ee3492fe30e4}{setupVertexAttributes}}();}
\DoxyCodeLine{00165\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_ae97479b18d4aa965bfede8e68520f9bd}{setupBuffers}}(GLuint\&\ vertexbuffer,\ \textcolor{keyword}{const}\ std::vector<Vertex>\&\ vertices,\ GLuint\&\ indexbuffer,\ \textcolor{keyword}{const}\ std::vector<unsigned\ int>\&\ indices);}
\DoxyCodeLine{00184\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a15ab9bea9e8686fbe8e2a6815f414503}{cleanup}}(GLFWwindow*\ window,\ std::vector<Object>\&\ objects,\ GLuint\ programID,\ GLuint\ VertexArrayID,\ GLuint\&\ TextureID,\ GLuint\&\ LightID,}
\DoxyCodeLine{00185\ \ \ \ \ GLuint\&\ MaterialAmbientColorID,\ GLuint\&\ MaterialDiffuseColorID,\ GLuint\&\ MaterialSpecularColorID,\ GLuint\&\ MatrixID,\ GLuint\&\ ViewMatrixID,}
\DoxyCodeLine{00186\ \ \ \ \ GLuint\&\ ModelMatrixID);}
\DoxyCodeLine{00187\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_abb14214ff67e919f55a92b86a0ec79d1}{loadingObject}}(\textcolor{keyword}{const}\ std::string\&\ filename,\ \mbox{\hyperlink{class_object}{Object}}\&\ obj);}
\DoxyCodeLine{00188\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a3bf8fed1fb5996ae7047f4821514d29b}{loadTextures}}(\mbox{\hyperlink{class_object}{Object}}\&\ obj);}
\DoxyCodeLine{00189\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a21dc407bf79c7ab357937beb739158fd}{loadObjAndTextures}}(\textcolor{keyword}{const}\ std::string\&\ filename,\ \mbox{\hyperlink{class_object}{Object}}\&\ obj);}
\DoxyCodeLine{00190\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a4fff386bd0495e094e84aa3f2333811c}{batchingObj}}(\mbox{\hyperlink{class_object}{Object}}\&\ obj);}
\DoxyCodeLine{00191\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a53821b06fa0fc9ee4d459706b4e2a231}{loadObjAndBatching}}(\textcolor{keyword}{const}\ std::string\&\ filename,\ \mbox{\hyperlink{class_object}{Object}}\&\ obj);}
\DoxyCodeLine{00192\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a93f4bd652857b99283eb669be62320c3}{addNewObject}}(\textcolor{keyword}{const}\ std::string\&\ filename,\ std::vector<Object>\&\ objects);}
\DoxyCodeLine{00193\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a05939fd662d197f395fd5fad460cf1a5}{copyObjectAndAdd}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_object}{Object}}\&\ obj,\ std::vector<Object>\&\ objects);}
\DoxyCodeLine{00194\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_ada42dad34b781b6b47fda1b31360b777}{setupHandlesForUniforms}}(GLuint\&\ programID,\ GLuint\&\ TextureID,\ GLuint\&\ LightID,\ GLuint\&\ MaterialAmbientColorID,}
\DoxyCodeLine{00195\ \ \ \ \ GLuint\&\ MaterialDiffuseColorID,\ GLuint\&\ MaterialSpecularColorID,\ GLuint\&\ MatrixID,\ GLuint\&\ ViewMatrixID,\ GLuint\&\ ModelMatrixID);}
\DoxyCodeLine{00196\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a1b8747f6a19bea1095596b0d6c0e0462}{drawObject}}(\mbox{\hyperlink{class_object}{Object}}\&\ \textcolor{keywordtype}{object},\ GLuint\ TextureID,\ GLuint\ MaterialAmbientColorID,\ GLuint\ MaterialDiffuseColorID,}
\DoxyCodeLine{00197\ \ \ \ \ GLuint\ MaterialSpecularColorID);}
\DoxyCodeLine{00198\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a2f532028382f0b1215e3240d9546659e}{translateObject}}(\mbox{\hyperlink{class_object}{Object}}\&\ \textcolor{keywordtype}{object},\ \textcolor{keyword}{const}\ glm::vec3\&\ translation);}
\DoxyCodeLine{00199\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_aff1f96c88383a04b810b5ad9a47bd4c1}{rotateObject}}(\mbox{\hyperlink{class_object}{Object}}\&\ \textcolor{keywordtype}{object},\ \textcolor{keywordtype}{float}\ angle,\ \textcolor{keyword}{const}\ glm::vec3\&\ axis);}
\DoxyCodeLine{00200\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_a79acbdc63ceb9cc4675f200d57b03586}{scaleObject}}(\mbox{\hyperlink{class_object}{Object}}\&\ \textcolor{keywordtype}{object},\ \textcolor{keyword}{const}\ glm::vec3\&\ scale);}
\DoxyCodeLine{00201\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{object_8hpp_ac97e52ddf4b9d85af238aa36dcbaa683}{sendMVPData}}(\mbox{\hyperlink{class_object}{Object}}\&\ \textcolor{keywordtype}{object},\ \textcolor{keywordtype}{float}\ angle,\ \textcolor{keyword}{const}\ glm::vec3\&\ axis,\ GLuint\ VertexArrayID,\ GLuint\ MatrixID,}
\DoxyCodeLine{00202\ \ \ \ \ GLuint\ ModelMatrixID,\ GLuint\ ViewMatrixID);}
\DoxyCodeLine{00203\ }
