...
VxV is a homemade Open\+GL engine we\textquotesingle{}ve been working on since almost 4 weeks. ~\newline
 ...
 \DoxyHorRuler{0}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md2}{}\doxysubsubsection{\texorpdfstring{💬 How to use ?}{💬 How to use ?}}\label{md__r_e_a_d_m_e_autotoc_md2}
It is actually pretty simple, just download the Alpha release, compile it in your Visual Studio and the .exe should appear in the Debug folder. Simple. \DoxyHorRuler{0}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md3}{}\doxysubsubsection{\texorpdfstring{⚠️ Note}{⚠️ Note}}\label{md__r_e_a_d_m_e_autotoc_md3}
We are still working on this project so the releases are not perfect and you may encounter issues or bugs while using it \+:) ~\newline
 👇🏼 If you are interested in the extern libraries we used it\textquotesingle{}s just down below ~\newline
 \DoxyHorRuler{0}
 \hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysubsection{\texorpdfstring{External Libraries \+:}{External Libraries \+:}}\label{md__r_e_a_d_m_e_autotoc_md4}
...
GLEW helped us loading and managing Open\+GL the "{}easy"{} way. It\textquotesingle{}s in some way a portal between us and Open\+GL, and it makes Open\+GL convenient to use. ~\newline
